...
public class Traj {
    ...
    // TODO: Split the Traj into parts if needed

    TrajectorySequence RedBotRight = drive.trajectorySequenceBuilder(new Pose2d(-36.00, -63.00, Math.toRadians(90.00)))
            .splineTo(new Vector2d(-34.31, -29.75), Math.toRadians(0.00))
            .addDisplacementMarker(() -> {
                // TODO: Drop Pixel
            })
            .lineTo(new Vector2d(-51.04, -18.11))
    ...
    TrajectorySequence BlueBotLeft = drive.trajectorySequenceBuilder(new Pose2d(-36.00, 63.00, Math.toRadians(270.00)))
            .splineTo(new Vector2d(-34.31, 29.75), Math.toRadians(360.00))
            .addDisplacementMarker(() -> {
                // TODO: Drop Pixel
            })
            .lineTo(new Vector2d(-51.04, 18.11))
